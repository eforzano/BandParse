...
def artistparse():
	...
	name = str(input('Input an artist name (ex: "Passion Pit")[press ENTER to quit]: '))

	# Continues loop until the user presses 'Enter' quit
	while name is not '':
		...
		# user inputs artist name
		name = input('Input an artist name (ex: "Passion Pit")[press ENTER to quit]: ')
